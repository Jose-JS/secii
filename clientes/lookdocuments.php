...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Documentos y Fotos del Técnico</title>
...
?>  
                    <div class="input-field col m6 s12">  <CENTER> ACTA DE NACIMIENTO</CENTER>
                <iframe src="<?php echo htmlentities($result->birthcertificate);?>" title="ACTA DE NACIMIENTO"width="500" height="500"></iframe>  
                <hr style="border-color:black;">
                 </div>
                 
            <div class="input-field col m6 s12"> <CENTER> COMPROBANTE DE DOMICILIO</CENTER>      
                <iframe src="<?php echo htmlentities($result->docadress);?>" width="500" height="500"></iframe> 
                <hr style="border-color:black;">
                </div>
                                        
            <div class="input-field col m6 s12">         <CENTER> COMPROBANTE DE ESTUDIOS</CENTER>
            <iframe src="<?php echo htmlentities($result->docstudies);?>" width="500" height="500"></iframe>   
               <hr style="border-color:black;">
                </div>
           <div class="input-field col m6 s12">  <CENTER> CARTILLA MILITAR</CENTER>
