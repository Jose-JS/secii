...
?>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Recursos Materiales | MATERIAL ENTREGADO A TESI</title>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Administrar Material Entregado</div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="table-responsive">
                                <table id="example5" class="cell-border display compact responsive nowrap" width="100%">
                                    <thead>
                                        <tr>
                                            <th>NO.</th>
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT * from  tblinventoryexit WHERE folio is null order by fecha desc";
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {               ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a name="create_pdf" href="#" onClick="mensaje(<?php echo htmlentities($result->empid); ?>,<?php echo htmlentities($result->id); ?>,<?php echo htmlentities($result->folio); ?>)" title="PDF RESPONSIVA" class="tooltipped" data-position="bottom" data-tooltip="PDF RESPONSIVA"><i class="material-icons">assignment</i></a>
