...
$ruta1 = '../recursosmateriales/firmas/'.$fecha1.$no_aleatorio1.$fileName1;//foto medio cuerpo
opendir($ruta1);
...
$sql='UPDATE tblinventoryfol set firm2=:contract1,creatoruser=:creatoruser,action=:action where folio=:folio';
...
<head>
    ...
    <!-- Title -->
    <title>Recursos Materiales | Firmas Entrega</title>
    ...
    <main class="mn-inner">
        <div class="row">
            ...
            $folio = $_GET['folio'];
				...
				?>
						<?php if ($result22->firm2 == null) {	?>
                <div class="card">
                    <div class="card-content">
                        <div class="page-title">FIRMA DE ENTREGA</div>
                        <div class="row">
