...
if($a>0){
    ...
    $sql3="INSERT INTO tblinventoryexit(descripcion,condicion,cantidad,fecha,serie,tecnico,comentario,tecnicoasig,empid,creatoruser,action,talla,id_responsiva) VALUES(:descripcion,:condicion,:cantidad,:fecha,:serie,:tecnico,:comentario,:tecnicoasig,:empid,:creatoruser,:action,:talla,'$responsiva')";
