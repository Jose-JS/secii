...
?>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Recursos Materiales | Administrar Entradas</title>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Administrar Entradas</div>
                </div>

                <div class="col s12 m12 l12">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title">Información entrada de material</span>
