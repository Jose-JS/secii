...
$sql ="SELECT user,password,id FROM tblusers WHERE user=:uname and password=:password and (kind='recursos materiales' OR kind='admin') and status=1";
...
$_SESSION['recursos']=$_POST['username'];
...
<head>
    ...
    <!-- Title -->
    <title>SECII | Recusos Materiales</title>
...
<body class="signin-page">
    ...
    <div class="mn-content valign-wrapper">
        ...
        <main class="mn-inner container">
            <h4 align="center"><a href="../index.php" bgcolor="white">Recursos Materiales</a></h4>
            <div class="valign">
                <div class="row">
