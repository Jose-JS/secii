...
$chngpwd1->execute();
$msg="Tu contraseña se cambio con exito";
}
...
.succWrap{
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i> recuperar contraseña</a></li>
                       ...
                       <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="material-icons">account_box</i>logueo de administrador</a></li>
          ...
          <div class="footer">
                    <!--<p class="copyright"><a href="">sistema SIM</a>©</p>-->
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Recuperación de contraseña del Técnico</h4></div>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Detalles sobre Técnicos</span>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="col s12 right-align m-t-sm">
                                                   ...
                                                   <input type="submit" name="submit" value="consultar" class="waves-effect waves-light btn teal">
                                               </div>
                                           </form>
                                      </div>
                                  </div>
...
foreach ($results as $result) {
 ...
 <div class="row">
  ...
  <div class="input-field col s12">
 <input id="password2" type="password" name="newpassword" class="validate" autocomplete="off" required>
                                                <label for="password">Nueva contraseña</label>
                                            </div>

<div class="input-field col s12">
<input id="password3" type="password" name="confirmpassword" class="validate" autocomplete="off" required>
...
<div class="errorWrap" style="margin-left: 2%; font-size:22px;">
 <strong>ERROR</strong> : <?php echo htmlentities("Detalles invalidos");
}?></div>
<?php } ?>
