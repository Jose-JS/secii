...
<head>
    ...
    <!-- Title -->
    <title>Admin | Actualizar Técnico</title>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <form id="AUTO" method="post" name="update" enctype="multipart/form-data">
                            ...
                            <div>
                                <h3>FICHA TECNICA</h3>
                                <img id="foto" name="foto" autocomplete="off" src="<?php echo htmlentities($resul->imagehalfbody);?>" onclick="javascript:this.width=100;this.height=120" ondblclick="javascript:this.width=350;this.height=400" width="100" height="120" required>
                                <section>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="empcode">Matricula de Técnico</label>
...
{   ?>
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input id="nationality" value="<?php echo htmlentities($resul->nationality);?>" name="nationality" type="text" autocomplete="off" required>
                                                        </div>

                                                        <div class="input-field col m6 s12">
                                                            <label for="nationality">Facha de nacimiento</label><br><br>
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input name="email" type="email" id="email" value="<?php echo htmlentities($resul->EmailId);?>" autocomplete="off" readonly required>
...
{   ?>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="fechini">Fecha </label><br>
                                            ...
                                            <div class="col m6">
                                                <div class="row">
                                                    <div class="input-field col m6 s12">
                                                        ...
                                                        <input id="debts" name="debts" value="<?php echo htmlentities($resul->debts);?>" type="text" disabled>
                                                    </div>
                                                    <div class="input-field col m6 s12">
...
<script>
    ...
    function valid() {
        ...
        if (txtDepartament == null) {
            ...
            return false;
        } else if (txtAssignedservice == null) {
            // Si no se cumple la condicion...
