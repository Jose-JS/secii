...
$ruta20 ='../Documentos/'.$fecha20.$no_aleatorio20.$_FILES['foto20']['name'];//No adeudo infonavit
opendir($ruta20);
...
$ruta21 ='../Documentos/'.$fecha21.$no_aleatorio21.$_FILES['foto21']['name'];//No adeudo infonavit
opendir($ruta21);
...
$ruta22 ='../Documentos/'.$fecha22.$no_aleatorio22.$_FILES['foto22']['name'];//No adeudo infonavit
opendir($ruta22);
...
$ruta23 ='../Documentos/'.$fecha23.$no_aleatorio23.$_FILES['foto23']['name'];//No adeudo infonavit
opendir($ruta23);
...
$ruta24 ='../Documentos/'.$fecha24.$no_aleatorio24.$_FILES['foto24']['name'];//No adeudo infonavit
opendir($ruta24);
                                        ...
                                        <div class="row">
                                            <div class="col m6">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="foto20">Medio cuerpo <font color="red">*</font></label><br><br>
                                                        <input id="foto20" name="foto20" type="file" maxlength="30" autocomplete="off" required>
                                                    </div>

                                                    <div class="input-field col m6 s12">
                                                        <label for="foto21">Cuerpo completo <font color="red">*</font></label><br><br>
                                                        <input id="foto21" name="foto21" type="file" maxlength="30" autocomplete="off" required>
                                                    </div>
                                                    
                                                    <div class="input-field col m6 s12">
                                                        <label for="foto22">Toxicológico<font color="red">*</font></label><br><br>
                                                        <input id="foto22" name="foto22" type="file" maxlength="30" autocomplete="off" required>
                                                    </div>
                                            ...
                                            <div class="col m6">
                                                <div class="row">
                                                    <div class="input-field col m6 s12">
                                                        <label for="foto23">Perfil izquierdo <font color="red">*</font></label><br><br>
                                                        <input id="foto23" name="foto23" type="file" maxlength="30" autocomplete="off" required>
                                                    </div>

                                                    <div class="input-field col m6 s12">
                                                        <label for="foto24">Perfil derecho <font color="red">*</font></label><br><br>
                                                        <input id="foto24" name="foto24" type="file" maxlength="30" autocomplete="off" required>
                                                    </div>
