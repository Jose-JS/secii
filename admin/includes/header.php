...
$query -> execute();?>">
                                    <div class="notification">
                                        ...
                                        <div class="notification-text">
                                            <p><b><?php echo htmlentities($result->EmpId." ".$result->name." ".$result->FirstName);?><br /></b> creación de doblete </p><span> <?php echo htmlentities($result->datetime);?></span>
                                        </div>
                                    </div>
                                </a>
                            </li>
...
$isread=0;
$sql = "SELECT * from tblactadmin where isread=:isread";
$query = $dbh -> prepare($sql);
$query->bindParam(':isread',$isread,PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
$dia = date("d", $fechaEntera);
                            ...
                            <li>
                                <a href="managedoublets.php?actadminid=<?php echo htmlentities($result->id);
$id=$_GET['actadminid'];
$isread=1;
...
$query -> execute();?>">
                                    <div class="notification">
                                        ...
                                        <div class="notification-text">
                                            <p><b><?php echo htmlentities($result->empid." ".$result->technical);?><br /></b> creación de acta administrativa </p><span> <?php echo htmlentities($result->date);?></span>
                                        </div>
                                    </div>
                                </a>
                            </li>
...
//var_dump("$undercount");                            ?>
                    ...
                    <li class=" hide-on-small-and-down "><a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button dropdown-right show-on-large ">
                            ...
                            <span class="badge"><?php echo htmlentities($unreadcount);?></span></div>
                        </a></li>
                    <?php } else{?>
