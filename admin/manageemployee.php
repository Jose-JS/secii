...
<a name="add_document" href="adddocument.php?empid=<?php echo htmlentities($result->id);?>"title="Agregar documentos"><i class="material-icons">library_books</i></a>
...
<a name="look_documents" href="lookdocuments.php?empid=<?php echo htmlentities($result->EmpId);?>" title="Visualizar documentos e imagenes"><i class="material-icons">visibility</i></a> <BR>    
