                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <?php if($msg){?><div class="succWrap content"><strong>ÉXITO</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
...
{         
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Nombre del Técnico:</b></td>
  ...
  <tr>
                                            ...
                                            <td>Desde  <?php echo htmlentities($result->FromDate);?> a <?php echo htmlentities($result->ToDate);?></td>
                                            <td style="font-size:16px;"><b>Fecha de publicación</b></td>
                                           <td><?php echo htmlentities($result->PostingDate);?></td>
                                        </tr>

<tr>
                                             <td style="font-size:16px;"><b>Descripción Permiso del Técnico : </b></td>
...
if($result->AdminRemark==""){
  echo "A la espera de la aprobación";  
}
else{
