...
$sql ="SELECT user,password,id FROM tblusers WHERE user=:uname and password=:password and (kind='monitorista' OR kind='admin' OR kind='monitorista1') and status=1";
...
<body class="signin-page">
    ...
    <div class="mn-content valign-wrapper">
        ...
        <main class="mn-inner container">
            <h4 align="center"><a href="../index.php" bgcolor="white">C.I.M.O.</a></h4>
            <div class="valign">
                <div class="row">
