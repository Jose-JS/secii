...
$sql="UPDATE tblformatab SET firm3=:contract,creatoruser=:creatoruser,action=:action WHERE folio=:eid";
...
echo "<script>alert('Firma ingresada con éxito');</script>";	
...
{            
									...
									//var_dump($result22->firm3);	?>
										  <?php if($result22->firm3==null){	?>
											<div class="input-field col m6 s12">
												<div id="signature-pad" class="signature-pad">
													<div class="description">FIRMA Y NOMBRE DE C.I.M.O.</div>
