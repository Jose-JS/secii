...
$ruta = '../cimo/firmas/'.$fecha.$no_aleatorio.$fileName;//foto medio cuerpo
opendir($ruta);
...
$ruta1 = '../cimo/firmas/'.$fecha1.$no_aleatorio1.$fileName1;//foto medio cuerpo
opendir($ruta1);
//copy($_FILES[$fileName.'']['tmp_name'],$ruta2);
$contract1=$ruta1;    
...
$ruta2 = '../cimo/firmas/'.$fecha2.$no_aleatorio2.$fileName2;//foto medio cuerpo
opendir($ruta2);
//copy($_FILES[$fileName.'']['tmp_name'],$ruta2);
$contract2=$ruta2;    
...
$ruta3 = '../cimo/firmas/'.$fecha3.$no_aleatorio3.$fileName3;//foto medio cuerpo
opendir($ruta3);
//copy($_FILES[$fileName.'']['tmp_name'],$ruta2);
$contract3=$ruta3;    
