    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Administrar Formato FAR</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive nowrap" width="100%">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from tbldoubletsa order by id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>  
                                    ...
                                    <?php if($result->nota==null || $result->nota==null){	?>
                                            
                                            <a href="editformata.php?i=<?php echo htmlentities($result->id);?>"><i class="material-icons">edit</i></a>
                                            <?php }else{}	?>          
