...
<body>
	...
	<main class="mn-inner">
		<div class="row">
			<div class="col s12">
				<div class="page-title">Administrar Formato FBR</div>
			</div>
				...
				<div class="card">
					<div class="card-content">
						...
						<table id="example" class="display responsive nowrap" width="100%">
							...
							<tbody>
								<?php $sql = "SELECT * from tbldoubletsb order by id desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>
								<tr>
									...
									<td>
										...
										<a href="editformatb.php?i=<?php echo htmlentities($result->id);?>"><i class="material-icons">edit</i></a>
										<?php }else{}	?>
									</td>
								</tr>
								<?php $cnt++;} }?>
