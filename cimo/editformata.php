...
$sql="UPDATE tbldoubletsa SET nota=:nota,creatoruser=:creatoruser,action=:action WHERE id=:id";   
...
$msg="Modificación de Formato FAR";
echo "<script>
...
<head>
	...
	<!-- Title -->
	<title>C.I.M.O. | Editar FORMATO FAR</title>
...
<div class="page-title">FORMATO FAR</div>
						<div class="row">
							<form id="AUTO" class="col s12" method="post" enctype="multipart/form-data">
								...
								<?php 
	 $id=$_GET['i'];
	$sql = "SELECT * from tbldoubletsa where id=:id";
$query = $dbh -> prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_STR);
$query->execute();
