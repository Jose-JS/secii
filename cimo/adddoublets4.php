...
$sql="INSERT INTO tbldoubletsa(folio,fecha,sedeorig,empid,tesireac,turnoreac,sedecubre,turnocubre,tesi,motivo,creatoruser,action,gen,action2) VALUES(:folio,:fecha,:sedeorig,:empid,:tesireac,:turnoreac,:sedecubre,:turnocubre,:tesi,:motivo,:creatoruser,:action,:gen,:action2)";
