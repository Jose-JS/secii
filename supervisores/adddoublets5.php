...
$sql="INSERT INTO tbldoubletsb(folio,fecha,sedeorig,empid,tesireac,turnoreac,sedecubre,turnocubre,tesi,motivo,creatoruser,action,gen,notasup) VALUES(:folio,:fecha,:sedeorig,:empid,:tesireac,:turnoreac,:sedecubre,:turnocubre,:tesi,:motivo,:creatoruser,:action,:gen,:notasup)";
...
{   ?>
								...
								<div class="input-field col m6 s12">
									...
									<input type="radio" id="homex1AA" name="motivo" value="SERVICIO EXTRAORDINARIO" class="check"> <label for="homex1AA">Servicio Extraordinario</label>
								</div>
                               								<div class="input-field col s12">
