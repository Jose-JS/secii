...
require_once('../supervisores/pdfpat.php');
$DateAndTime = date('m-d-Y h:i:s a', time()); 
$css=file_get_contents('../supervisores/styleformat.css');
$mpdf= new \Mpdf\Mpdf([
...
$mpdf->SetHTMLFooter('<div style="text-align: center;">{PAGENO}</div><div style="text-align: right;">{DATE j-m-Y}</div>');
