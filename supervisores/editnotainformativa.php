...
$sql="UPDATE tblnoteinformative SET invoice=:invoice,fech=:fech,motiv=:motiv,service=:service,turn=:turn,descr=:descr,creatoruser=:creatoruser,action=:action,letter=:letter  where id=:id";
...
<body>
    ...
    <main class="mn-inner">
        <div class="row">
            <div class="col s12">
                <div class="page-title">Anexo C</div>
            </div>
...
$invoice=$_GET['i'];
$letter=$_GET['l'];	
$sql = "SELECT * from  tblnoteinformative where letter=:letter and invoice=:invoice  order by id desc limit 1";
$query = $dbh -> prepare($sql);
$query -> bindParam(':invoice',$invoice, PDO::PARAM_STR);
$query -> bindParam(':letter',$letter, PDO::PARAM_STR);	
$query->execute();
...
{   ?>
                                        ...
                                        <?php }} ?>
                                             ...
                                             <div class="input-field col m6 s12">
                                                ...
                                                <textarea name="desc" value="<?php echo htmlentities($resul->desc);?>"id="desc" autocomplete="off" required><?php echo htmlentities($resul->descr);?></textarea>
                                            </div>
