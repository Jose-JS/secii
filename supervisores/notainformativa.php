...
$sql="INSERT INTO tblnoteinformative(invoice,fech,motiv,service,turn,descr,firm,creatoruser,action,letter) VALUES(:invoice,:fech,:motiv,:selected,:turn,:descr,:contract,:creatoruser,:action,:letter)";
...
$msg="Registro de Anexo C, agregado con éxito";
echo "<script>
