...
$invoice=$_GET['i'];
$letter=$_GET['l'];	
$sql = "SELECT * from  tblactadmin where letter=:letter and invoice=:invoice  order by id desc limit 1";
$query = $dbh -> prepare($sql);
$query -> bindParam(':invoice',$invoice, PDO::PARAM_STR);
$query -> bindParam(':letter',$letter, PDO::PARAM_STR);	
$query->execute();
...
{              //var_dump($resul);
                    ?>
											...
											<div class="input-field col m6 s12">
												...
												<input id="date" value="<?php echo htmlentities($resul->date);?>"name="date" type="date" autocomplete="off" required>
											</div>

											<div class="input-field col m6 s12">
												<label for="reason">Motivo</label><br>
												<input id="reason" value="<?php echo htmlentities($resul->reason);?>"name="reason" type="text" autocomplete="off" required>
											</div>
											...
											<div class="input-field col m6 s12">
												<select id="service" name="service" autocomplete="off">
													...
													<?php $sqll = "SELECT servicename from tblserviceassigned";
									...
									<div class="col m6 s12">
										<div class="row">
											...
											<div class="input-field col s12">
												...
												<textarea rows="10" cols="40" value="<?php echo htmlentities($resul->description);?>"name="description" id="description" autocomplete="off" required style="resize: both;"><?php echo htmlentities($resul->description);?></textarea>
