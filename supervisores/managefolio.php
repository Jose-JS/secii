...
?>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Supervisión | Administrar Salidas Folio</title>
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {               ?>
                                                <tr>
                                                    ...
                                                    <a  href="addfirm6.php?folio=<?php echo htmlentities($result->folio); ?>" class="tooltipped" target="_blank" title="FIRMA QUIEN ENTREGA" data-position="bottom" data-tooltip="FIRMA QUIEN ENTREGA"><i class="material-icons">done_all</i></a>
                                                    <?php } else{}?>
                                                </td>
