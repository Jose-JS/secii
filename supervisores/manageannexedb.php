                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Información de Actas Administrativas</span>
                                ...
                                <table id="example" class="display responsive nowrap" width="100%">
                                    ...
                                    <tbody>
<?php $sql = "SELECT * from tblactadmin order by date desc";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->campus);?></td>
                                            <td><?php echo htmlentities($result->service);?></td>
                                            <td><a href="creator_pdf_b2.php?i=<?php echo htmlentities($result->id);?>" target="_blank"><i class="material-icons">picture_as_pdf</i></a></td>                                      
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
