...
$sql="UPDATE tbldoubletsb SET fecha=:fecha,sedeorig=:sedeorig,empid=:empid,tesireac=:tesireac,turnoreac=:turnoreac,sedecubre=:sedecubre,turnocubre=:turnocubre,tesi=:tesi,motivo=:motivo,creatoruser=:creatoruser,action=:action,gen=:gen,notasup=:notasup where id=:eid";
...
$msg="Registro de Formato FBR, modificado con éxito";
echo "<script>
...
<head>
	...
	<!-- Title -->
	<title>Supervisores | FORMATO FBR</title>
		...
		<div class="row">
			<div class="col s12">
				<div class="page-title">FORMATO FBR</div>
			            ...
			            <?php 
$eid=$_GET['d'];
$sql = "SELECT * from  tbldoubletsb where id=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
{   ?>
								...
								<div class="input-field col m6 s12">
									...
									<input type="radio" id="homex1z" name="motivo" value="APOYO" <?php if(($resultt->motivo) =='DESCANSO') print "checked=true"?> readonly> <label for="homex1z">Descanso</label>
