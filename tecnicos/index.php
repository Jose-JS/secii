...
$sql="SELECT * FROM tblemployees where FirstName=:uname and EmpId=:password and Status='1'";
...
$_SESSION['tecnico']=$_POST['username'];
...
<head>
    ...
    <!-- Title -->
    <title>S E C I I | Técnicos</title>
...
<body class="signin-page">
    ...
    <div class="mn-content valign-wrapper">
        ...
        <main class="mn-inner container">
            <h4 align="center"><a href="../index.php" bgcolor="white">Técnicos</a></h4>
            <div class="valign">
                <div class="row">
