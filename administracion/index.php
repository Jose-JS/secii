...
$sql ="SELECT user,password,kind,id FROM tblusers WHERE user=:uname and password=:password and (kind='administracion' OR kind='admin') and status=1";
...
$sql3="UPDATE tblusers set started=:started where user=:uname";
$query3= $dbh->prepare($sql3);
$query3->bindParam(':started',$started,PDO::PARAM_STR);
$query3->bindParam(':uname',$uname,PDO::PARAM_STR);    
$query3->execute();    
...
echo "<script type='text/javascript'> document.location = 'dashboard.php?i=$result->id'; </script>";
} else{
