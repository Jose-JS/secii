...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(0, 12, 'ANEXO TESI', 0, 2, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(0, 2, '', 0, 2, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(0, 8, 'VERSION DE LOS HECHOS', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
$sql = "SELECT * FROM tblannexedtesi where id='$eid' ";	
...
$pdf->SetAuthor('JJSH');
$pdf->SetTitle('ANEXO TESI');
$pdf->SetSubject('ANEXO TESI');
$pdf->SetKeywords('TCPDF, PDF, ANEXO TESI');
...
// set some text to print
    ...
    $content .='<tr>';
    $content .='<td colspan="5" border="1"align="left"><b>MOTIVO:</b> '.$motiv.'</td>';
    $content .='<td colspan="2" border="1"align="left"><b>FECHA:</b> '.$fech.'</td>';
    $content .='</tr>';
        
    $content .='<tr>';
    $content .='<td colspan="3" border="1" align="left"> <b>TECNICO:</b> '.$idemp.$technical.'</td>';    
    $content .='<td colspan="2" border="1" align="left"> <b>TURNO:</b> '.$turn.'</td>';
    $content .='<td colspan="2" border="1" align="left"> <b>SEDE:</b> '.$service.'</td>';    
    $content .='</tr>';    
    ...
    $content .='</tr>';    
    $content .='<tr>';
    $content .='<td colspan="5"align="center"> '.$descr.'</td>';
    $content .='</tr>';    
...
$firm3=$result2['firm3'];                
    ...
    $content .='<tr>';
    $content .='<td colspan="2"align="center"><img src="'.$firm.'" align="left" width="120" height="100"></td>'; 
    $content .='<td colspan="2"align="center"><img src="'.$firm1.'" align="left" width="120" height="100"></td>'; 
    $content .='</tr>';   
        
    $content .='<tr>';
    $content .='<td colspan="2"align="center"><b>FIRMA DEL TECNICO</b></td>';
