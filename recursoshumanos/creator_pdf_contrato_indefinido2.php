...
if ($query->rowCount() > 0) {
    foreach ($query as $result) {
        ...
        <p>CONTRATO INDIVIDUAL DE TRABAJO POR TIEMPO INDETERMINADO QUE CELEBRAN POR UNA PARTE ' . $company . ' QUIEN EN LO SUCESIVO Y PARA
...
<p>El presente contrato tendrá la vigencia de <b>INDETERMINADO</b>, que correrá desde el día de la
