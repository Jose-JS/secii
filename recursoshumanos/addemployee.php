...
<head>
    ...
    <script type="text/javascript">
        ...
        function valid() {
            ...
            var txtCode = document.getElementById('empcode').value;
            ...
            if (txtCode == null || txtCode == 0 || /^\s+$/.test(txtCode)) {
                alert('[ERROR] Por favor ingrese matrícula');
                return false;
            }

            if (txtEmail == null || txtEmail == 0 || /^\s+$/.test(txtEmail)) {
                alert('[ERROR] Por favor ingrese correo electrónico');
                return false;
            } else if (txtDepartament == null || txtDepartament == 0) {
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input name="empcode" id="empcode" tabindex="1" onBlur="checkAvailabilityEmpid()" maxlength="6" type="text" autocomplete="off" required>
                                                            <span id="empid-availability" style="font-size:12px;"></span>
                                                        </div>

                                                        <div class="input-field col m6 s12">
                                                            <select id="departament" name="department" tabindex="2" autocomplete="off" required>
...
{   ?>
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <select id="assignedservice" name="assignedservice" tabindex="3" autocomplete="off">
...
{   ?>
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="nationality">Ingreso</label><br>

                                                            <input id="fechini" name="fechini" type="date" tabindex="4" autocomplete="off">
                                                        </div>
                                                    ...
                                                    <div class="col m6">
                                                        <div class="row">
                                                            <div class="input-field col m6 s12">
                                                                ...
                                                                <input id="dependentage" name="dependentage" type="text" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col m6">
                                                        <div class="row">
                                                            <div class="input-field col m6 s12">
                                                                ...
                                                                <input id="dependentage2" name="dependentage2" type="text" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col m6">
                                                        <div class="row">
                                                            <div class="input-field col m6 s12">
                                                                ...
                                                                <input id="dependentage3" name="dependentage3" type="text" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col m6">
                                                        <div class="row">
                                                            <div class="input-field col m6 s12">
                                                                ...
                                                                <input id="dependentage4" name="dependentage4" type="text" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col m6">
                                                        <div class="row">
                                                            <div class="input-field col m6 s12">
                                                                ...
                                                                <input id="dependentage5" name="dependentage5" type="text" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
