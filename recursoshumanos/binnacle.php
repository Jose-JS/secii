...
$dia = date("d", $fechaEntera);								?>
                                <tr>
                                    ...
                                    <td><a href="creator_pdf_a.php?i=<?php echo htmlentities($result->invoice);?>&d=<?php echo htmlentities($result->id);?>&emp=<?php echo htmlentities($result->empid);?>" target="_blank"><i class="material-icons">picture_as_pdf</i></a></td>
...
{               ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($result->reason);?></td>
                                    <td><?php echo htmlentities($result->turn);?></td>
                                    <td><a href="creator_pdf_b.php?i=<?php echo htmlentities($result->id);?>" target="_blank"><i class="material-icons">picture_as_pdf</i></a></td>
...
<div class="row">
            ...
            <div class="col s12 m12 l12">
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">Cambios de servicio</span>
                        ...
                        <table id="example" class="display responsive nowrap" width="100%">
                            ...
                            <tbody>
                                <?php
     $id=$_GET['empid'];
    $sql = "SELECT *from tblmoveservice  where empid=:id order by regdate desc";
$query = $dbh -> prepare($sql);
$query->bindParam(':id',$id,PDO::PARAM_STR);     
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
$dia = date("d", $fechaEntera);								
                                ...
                                <tr>
                                    <td> <?php echo htmlentities($cnt);?></td>
                                    <td><?php echo htmlentities($dia);?>-<?php echo htmlentities($mes);?>-<?php echo htmlentities($anio);?></td>
                                    <td><?php echo htmlentities($result->serviceo);?></td>
                                    <td><?php echo htmlentities($result->serviced);?></td>
                                </tr>
                                <?php $cnt++;} }?>
                            </tbody>
                        </table>
