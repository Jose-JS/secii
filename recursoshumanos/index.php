...
$sql ="SELECT user,password,id FROM tblusers WHERE user=:uname and password=:password and (kind='recursos humanos' OR kind='admin') and status=1";
...
<head>
    ...
    <!-- Title -->
    <title>SECII | Recusos Humanos</title>
...
<body class="signin-page">
    ...
    <div class="mn-content valign-wrapper">
        ...
        <main class="mn-inner container">
            <h4 align="center"><a href="../index.php" bgcolor="white">Recursos Humanos</a></h4>
            <div class="valign">
                <div class="row">
