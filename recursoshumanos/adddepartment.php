...
<head>
	...
	<!-- Title -->
	<title>Recursos Humanos | Agregar Puestos</title>
...
<body>
	...
	<main class="mn-inner">
		<div class="row">
			<div class="col s12">
				<div class="page-title">Agregar Puesto</div>
			</div>
