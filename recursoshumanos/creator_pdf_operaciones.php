...
if ($query->rowCount() > 0) {
    foreach ($query as $result) {
        ...
        $content .= '<table  CELLPADDING="2">';
        $content .= '<tr>';
        $content .= '<td colspan="2"align="CENTER">DIRECCION DE RECURSOS HUMANOS</td>';
        $content .= '<td colspan="2"align="CENTER"> DIRECCION DE OPERACIONES</td>';
        $content .= '</tr>';
        $content .= '</table>';
        
        $content .= '<table  CELLPADDING="2">';
        $content .= '<tr>';
        $content .= '<td colspan="2"align="CENTER"> <b>LIC. SILVIA LETICIA ZEPEDA OSORIO</b></td>';
        $content .= '<td colspan="2"align="CENTER"> <b>LIC. VAZQUEZ HURTADO JOSE FRANCISCO</b></td>';
        $content .= '</tr>';
        $content .= '</table>';
