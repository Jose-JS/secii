...
if($stats){
                                        ...
                                        <?php if($result->status==1)
                                           {?>
                                        <a href="managepdf.php?inid=<?php echo htmlentities($result->id);?>" onclick="return confirm ('¿Estás seguro de que quieres cancelar a este folio?');" title="Cancelar Folio" /> <i class="material-icons" title="Cancelar">lock</i>
                                        <?php } else {?>
                                        <a href="managepdf.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Seguro que quieres activar este folio?');" title="Activar Folio" /><i class="material-icons" title="Activar">lock_open</i>
                                        <?php } ?>                                  
                                        </td>   
                                        </tr>
                                         <?php $cnt++;} }?>
