...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        // Title
        $this->Cell(0, 10, 'ANEXO C', 0, 2, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(0, 2, '', 0, 2, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(0, 8, 'NOTA INFORMATIVA', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
$sql = "SELECT * FROM tblnoteinformative where id='$eid' ";
...
if ($query->rowCount() > 0) {
    foreach ($query as $result) {
        ...
        $pdf->SetAuthor('JJSH');
        $pdf->SetTitle('ANEXO C');
        $pdf->SetSubject('ANEXO C');
        $pdf->SetKeywords('TCPDF, PDF, ANEXO C');
        ...
        $content .= '<tr>';
        $content .= '<td colspan="5" border="1" align="left"> <b>SERVICIOS:</b> ' . $service . '</td>';
        ...
        if ($query2->rowCount() > 0) {
            foreach ($query2 as $result2) {
                ...
                $content .= '<tr>';
                $content .= '<td colspan="2"align="left"><b>FIRMA DIRECTOR DE OPERACIONES</b></td>';
                $content .= '<td colspan="2"align="left"><b>FIRMA DIRECTOR DE C.I.M.O.</b></td>';
                $content .= '</tr>';
