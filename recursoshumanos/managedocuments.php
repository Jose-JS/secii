...
{               ?>  
                                        <tr>
                                            ...
                                            <td><a href="creator_pdf_a2.php?i=<?php echo htmlentities($result->invoice);?>&d=<?php echo htmlentities($result->id);?>" target="_blank"><i class="material-icons">picture_as_pdf</i></a></td>                                      
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
...
{               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->invoice);?></td>
                                            <td><?php echo htmlentities($result->fech);?></td>
                                            <td><a href="creator_pdf_annexedtesi2.php?i=<?php echo htmlentities($result->id);?>" target="_blank"><i class="material-icons">picture_as_pdf</i></a></td>                                      
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
