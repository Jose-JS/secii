                                                ...
                                                <div class="col m6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="fechi">Fecha</label>
                                                            <input id="fechi" name="fechi" type="date" autocomplete="off">
                                                        </div>
...
{   ?>
                                                        ...
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="address" name="address" type="text" autocomplete="off" placeholder="Entre la calle y la calle" required>
                                                        </div>

                                                        <div class="input-field col m6 s12">
                                                            <label for="phonelocal">Telefono de Casa</label>
...
{   ?>
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="phone">Referencia para ubicar domicilio</label>
                                                            <input id="mobileno" name="mobileno" type="tel" maxlength="10" autocomplete="off" required>
                                                        </div>
...
<input id="foto" name="foto" type="file"  maxlength="30" autocomplete="off" required>  
    ...
    -->
                                                ...
                                                <h5>OBSERVACIONES DE LA VISITA</h5>
                                                <div class="col m6">

                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label for="address">Cuantas personas estuvieron presentes durante la entrevista</label>
                                                            <input id="address" name="address" type="text" autocomplete="off" placeholder="" required>
                                                        </div>

                                                        <div class="input-field col m6">
                                                            <select id="departament" name="department" autocomplete="off" required>
                                                                <option value="">Actitud Durante Entrevista</option>
                                                                <option value="coopero">coopero</option>
                                                                <option value="no coopero">no coopero</option>
                                                                <option value="otro">otro</option>

                                                            </select>
                                                        </div>
                                                        <div class="input-field col m6">
                                                            <label for="address">Con quien habita el entrevistado</label>
                                                            <input id="address" name="address" type="text" autocomplete="off" placeholder="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="city">Relacion con el entrevistado</label>
                                                            <input id="city" name="city" type="text" autocomplete="off" required>
                                                        </div>

                                                        <div class="input-field col m6">
                                                            <select id="departament" name="department" autocomplete="off" required>
                                                                <option value="">Familiares dentro de la empresa</option>
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            <label for="cp">Parentesco</label>
                                                            <input id="cp" name="cp" type="text" maxlength="5" autocomplete="off" required>
                                                        </div>

                                                        <div class="input-field col m6 s12">
                                                            <label for="phone">Puesto que ocupa</label>
                                                            <input id="mobileno" name="mobileno" type="tel" maxlength="10" autocomplete="off" required>
                                                        </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col m6">
                                                <div class="row">
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyname">Musica</label><br>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob">Frecuencia</label>
                                                        <input id="companyjob" name="companyjob" type="text">
                                                    </div>
                                                    <div class="input-field col  s12">
                                                        <label for="companyadress">Preferencia</label>
                                                        <input id="companyadress" name="companyadress" type="text">
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="timework">Cine</label><br>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone">Frecuencia</label>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="timework">TV</label><br>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone">Frecuencia</label>
                                                        <input id="companyphone" name="companyphone" maxlength="10" type="text">
                                            ...
                                            <div class="col m6">
                                                <div class="row">
                                                    <div class="input-field col m6 s12">
                                                        <label for="timework">Lectura</label><br>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone">Frecuencia</label>
                                                        <input id="companyphone" name="companyphone" maxlength="10" type="text">
                                                    ...
                                                    <div class="input-field col s12">
                                                        <label for="reasonexit">Preferencia</label>
                                                        <input id="reasonexit" name="reasonexit" type="text">
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="timework">Teatro</label><br>
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone">Frecuencia</label>
                                                        <input id="companyphone" name="companyphone" maxlength="10" type="text">
                                        ...
                                        <hr style="border-color:black;">
                                        <h4>SALUD E HIGIENE</h4>

                                        <div class="row">
                                            <div class="col m6">
                                                <div class="row">
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyname2">Defina su estado de salud</label>
                                                        <input id="companyname2" name="companyname2" type="text">
                                                    </div>

                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob2">Ha sido hospitalizado</label>
                                                        <input id="companyjob2" name="companyjob2" type="text">
                                                    </div>

                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob2">¿Cuál?</label>
                                                        <input id="companyjob2" name="companyjob2" type="text">
                                                    </div>

                                                    <div class="input-field col m6 s12">
                                                        <label for="timework2">Razón</label>
                                                        <input id="timework2" name="timework2" type="text">
                                                    </div>


                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob2">Incapacidades en los ultimos 2 años</label>
                                                        <input id="companyjob2" name="companyjob2" type="text">
                                                    </div>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob2">¿padece alguna enfermedad contagiosa?</label>
                                                        <input id="companyjob2" name="companyjob2" type="text">
                                                    </div>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">¿Que enfermedades ah padecido en el ultimo año?</label>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">¿Padece de problemas de visión?</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob2">¿Cuál?</label>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">Servicio medico</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>

                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">Estado de salud de la familia</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>


                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">Enfermedades familiares</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob2">¿Cuál?</label>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">¿Consumes bebidas alcoholicas?</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>

                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">¿Consumes alguna droga?</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>


                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">Ejercicio fisico que practica</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyjob2">¿Cuál?</label>
                                                    ...
                                                    <div class="input-field col m6 s12">
                                                        <label for="companyphone2">Frecuencia con que practica el ejercicio fisico</label>
                                                        <input id="companyphone2" name="companyphone2" maxlength="10" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col m6">
                                                        <select id="departament" name="department" autocomplete="off" required>
                                                            ...
                                                            <option value="porimera">primera</option>
                                                            <option value="media">media</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-field col m6">
                                                        <select id="departament" name="department" autocomplete="off" required>
                                                            <option value="">Unidad habitacional</option>
                                                    ...
                                                    <div class="input-field col m6">
                                                        <select id="departament" name="department" autocomplete="off" required>
                                                            <option value="">Vivienda popular</option>
                                                            <option value="vecindad">vecindad</option>
                                                            <option value="barranca">barranca</option>
                                                            <option value="jacal">jacal</option>
                                                        </select>
                                                    </div>

                                                    <label>Niveles de:</label>
                                                    <div class="input-field col m6">
                                                        <select id="departament" name="department" autocomplete="off" required>
                                                    ...
                                                    <label>Dimenciones y condiciones del inmueble</label>
                                                    <div class="input-field col m6">
                                                        <select id="departament" name="department" autocomplete="off" required>
