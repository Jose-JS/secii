...
$company=$result['company'];        
    ...
    $content .='<tr>';
    $content .='<td colspan="6"align="center" bgcolor="lightgrey"> <b>FICHA TECNICA</b></td>';
    $content .='</tr>';        
    ...
    $content .='<td colspan="2"align="center" bgcolor="lightgrey"> <b>SERVICIO ASIGNADO</b></td>';
        $content .='<td colspan="2"align="center" bgcolor="lightgrey"> <b>EMPRESA</b></td>';      
    $content .='</tr>';
        
    $content .='<tr>';
    $content .='<td colspan="2"align="center"> '.$matricula.'</td>';
    $content .='<td colspan="2" align="center">'.$assignedservice.'</td>';
    $content .='<td colspan="2"align="center"> '.$company.'</td>';        
    $content .='</tr>';
        
       
    
    $content .='<tr>';
    $content .='<td colspan="3"align="center" bgcolor="lightgrey"> <b>PUESTO</b></td>';        
    $content .='<td colspan="3"align="center" bgcolor="lightgrey"> <b>FECHA</b></td>';
    $content .='</tr>';    
        
    $content .='<tr>';
    $content .='<td colspan="3"align="center"> '.$department.'</td>';
    $content .='<td colspan="3" align="center">'.$fechini.'</td>';
    $content .='</tr>';
