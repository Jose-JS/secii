								...
								<div>
									...
									<section>
										<div class="wizard-content">
												...
												<fieldset>
													<div class="col m6">
														<div class="row">
															<div class="input-field col m6 s12">
																...
																<input name="empcode" id="empcode" onBlur="checkAvailabilityEmpid()" maxlength="6" type="text" autocomplete="off" tabindex="1" required data-memo>
																<span id="empid-availability" style="font-size:12px;"></span>
															</div>
															<div class="input-field col m6 s12">
																<select id="department" name="department" data-memo>
																	<option value="" selected="selected">Puesto <b><FONT COLOR="red">*</FONT></b></option>
													...
													<div class="col m6">
														<div class="row">
															...
															<div class="input-field col m6 s12">
																<select id="assignedservice" name="assignedservice" tabindex="21" autocomplete="off" required data-memo>
															...
															<div class="input-field col m6 s12">
																<select id="company" tabindex="22" name="company" autocomplete="off" data-memo>
															...
															<div class="input-field col m6 s12">
																<select id="marital" tabindex="23" name="marital" autocomplete="off" data-memo>
                                            ...
                                            <button onclick="memo_form.clean()" class="btn btn-info">Limpiar</button>
												...
												<div class="col m6">
													<div class="row">
														...
														<div class="input-field col m6 s12">
															...
															<input type="radio" id="homex1p" name="homex1" value="propio" class="check" data-memo> <label for="homex1p">Propio</label>
															<input type="radio" id="homex1r" name="homex1" value="rentada" class="check" data-memo> <label for="homex1r">Rentada</label>
															<input type="radio" id="homex1o" name="homex1" value="otra" class="check" data-memo> <label for="homex1o">Otra</label>
														</div>
														<div class="input-field col m6 s12">
															<label for="homex2">El hogar donde habita es:</label><br><br>
															<input type="radio" id="homex2c" name="homex2" value="casa" class="check" data-memo> <label for="homex2c">Casa</label>
															<input type="radio" id="homex2d" name="homex2" value="departamento" class="check" data-memo> <label for="homex2d">Departamento</label>
															<input type="radio" id="homex2o" name="homex2" value="otra" class="check" data-memo> <label for="homex2o">Otra</label>
														</div>
													</div>
												</div>
												<div class="col m6">
