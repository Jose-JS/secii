...
weight,stature,typeblood,company,creatoruser,action,banco,nocuenta,clabeint,sueldonet,fechaingreso,fechacapacitacion) 
...
:observations,:weight,:stature,:typeblood,:company,:creatoruser,:action,:banco,:nocuenta,:clabeint,:sueldonet,:fechaingreso,:fechacapacitacion)";
